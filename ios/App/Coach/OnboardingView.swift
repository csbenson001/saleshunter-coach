...
struct OnboardingView: View {
    ...
    /// than a heading that happens to say "Coach": Alexandria in the brand
    ...
    private var callToAction: some View {
        VStack(spacing: 12) {
            ...
            Text("Email and password, Google, and Apple all work. Before any recording starts, Coach asks you to confirm everyone in the room has agreed to it.")
                .font(.coach.caption)
                .foregroundStyle(Theme.mutedForeground)
                .multilineTextAlignment(.center)
                .fixedSize(horizontal: false, vertical: true)
...
struct LaunchView: View {
    var body: some View {
        ...
        .frame(maxWidth: .infinity, maxHeight: .infinity)
        .background(Theme.background)
        .accessibilityLabel("Loading Coach")
    }
}
