...
final class MeetingUploader {
    ...
    private let queue = DispatchQueue(label: "coach.recorder")

    init() throws {
        fileURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("coach-recording-\(id).ogg")
    ...
    private static func pendingDirectory() throws -> URL {
        ...
        let directory = base.appendingPathComponent("Coach/PendingUploads", isDirectory: true)
