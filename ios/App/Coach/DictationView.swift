...
/// keyboard — the transcript streams into the Coach keyboard and lands at the
...
struct DictationView: View {
    ...
    private var statusSubtitle: String {
        ...
        if needsManualReturn {
            return String(
                localized:
                    "Your words show up on the Coach keyboard and land at the cursor as you talk — nothing happens on this screen."
            )
        }
        ...
        VStack(spacing: 12) {
            ...
            ZStack(alignment: .leading) {
                ...
                Image(systemName: "arrow.right")
                    .font(.coach.footnote.weight(.bold))
