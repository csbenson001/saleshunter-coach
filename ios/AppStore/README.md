# SalesHunter Coach iOS App Store submission packet
...
3. Apply [`metadata/en-US.md`](metadata/en-US.md) to English (U.S.). It also
   records why the name, subtitle, and "what it does not do" section read the
   way they do — worth reading before overriding any of them.
4. Upload the screenshots: `screenshots/en-US/` to the English localization.
   They are 1320×2868, the 6.9-inch slot. Regenerate with
