# SalesHunter Coach for Android — Play Store submission packet
...
1. Play Console app record: name **SalesHunter Coach**, package `com.saleshunter.coach`
...
6. **Main store listing**: paste [`listing-en.md`](listing-en.md) into English
   (United States), then upload the graphics per
   [`assets/README.md`](assets/README.md).
7. Content rating (IARC), ads declaration (none), target audience, privacy
   policy URL `https://saleshunterlive.com/privacy/`.
