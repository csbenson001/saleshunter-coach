 ...
 *
 * The 401/403 discipline is the same on every Coach client: **401 means the
...
/**
 * HTTP client for the Coach cloud. Call-for-call the same contract as iOS
 * `CoachKit/CloudClient.swift` and the desktop's `src/lib/cloud/{client,sync}.ts`
