# CoachKit (Android) — public API

`:coachkit` is a pure Kotlin/JVM module (no Android APIs) holding the transcript
core, ported line-for-line from the iOS `CoachKit` Swift package, which was
...
Package: `com.saleshunter.coach.kit`.
