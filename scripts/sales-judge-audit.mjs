...
const TEST_SCENARIOS = [
  ...
  },
  {
    ...
    solutionOutput: "Decision Risk: Missing Economic Buyer budget authority. Ask: Aside from yourself, who signs off on the purchase order for this project?",
    dealSizeUsd: 60000,
  },
  {
    ...
    solutionOutput: "Budget freezes occur when tools fail to prove cash preservation. If our live HUD prevents deal slippage and saves $240,000 in pipeline this month, what metric does finance need to approve the purchase order?",
    dealSizeUsd: 50000,
  },
  {
    ...
    solutionOutput: "Next step commitment logged to Salesforce: Economic buyer review scheduled Thursday. Defended $24,000 margin value documented with executive timeline.",
    dealSizeUsd: 35000,
  },
];
